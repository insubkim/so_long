...
/*   Updated: 2023/01/24 00:08:05 by inskim           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
in	is_in_visited(t_node *node_visitied, int vertax_id)
{
	while (node_visitied)
	{
...
void	check_visited(t_node *visited, t_graph *map_graph, \
		char **map_arr, char c)
{
	int	*vertax_id;
	int	i;
...
void	check_path(t_graph *map_graph, char **map_arr)
{
	...
	check_c_e_visited(node_visited, map_graph, map_arr, queue);
}
